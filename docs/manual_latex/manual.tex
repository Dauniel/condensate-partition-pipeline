...
\begin{center}
\includegraphics[width=0.82\textwidth]{gui_single.png}\\
...
(and optional comparison against a manual reference CSV), use the GUI \textbf{Batch} tab.
